...
def generatePage():
    ...
    randX = random.randrange(1,SVG_WIDTH/2)
    randY = random.randrange(1,SVG_HEIGHT/2)
...
def generateRectangle(height,width,x,y):
    ...
    rect.write('style="fill:rgb('+ str(red) + ',' + str(green) + ',' + str(blue) + ');stroke-width:3;stroke:rgb(0,0,0)"/>\n')
